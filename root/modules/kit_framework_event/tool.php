...
try {
    ...
    <div style="width:100%;height:10px;margin:0 0 2px 0;padding:0;text-align:right;">
      <a href="{$CMS_URL}/kit2/event/cms/{$FRAMEWORK_PARAMETER}" target="_blank">
    ...
    <iframe id="kitframework_iframe" width="100%" height="700" src="{$CMS_URL}/kit2/event/cms/{$CMS_PARAMETER}" name="event" frameborder="0" style="border: 1px solid #ccc;" scrolling="auto" marginheight="0px" marginwidth="0px">
