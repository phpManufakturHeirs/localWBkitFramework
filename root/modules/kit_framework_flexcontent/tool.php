...
try {
    ...
    <div style="width:100%;margin:0;padding:5px;color:#000;background-color:#fff;">
      <div style="width:100%;height:15px;margin:5px 0;padding:0;text-align:right;">
        <a href="{$CMS_URL}/kit2/flexcontent/cms/{$FRAMEWORK_PARAMETER}" target="_blank">
      ...
      <iframe id="kitframework_iframe" width="100%" height="700" src="{$CMS_URL}/kit2/flexcontent/cms/{$CMS_PARAMETER}" name="flexcontent" frameborder="0" style="border:none" scrolling="auto" marginheight="0px" marginwidth="0px">
